...
class SetupScreen(tk.Frame):
    ...
    def _build(self):
        ...
        self.thr_lbl = tk.Label(thr_row,
            text=f"{self.threshold.get():.2f}",
            font=("Arial", 18, "bold"), fg=C["denso_red"], bg=C["bg_card"], width=5)
        self.thr_lbl.pack(side="left", padx=(0, 12))
        tk.Scale(thr_row, variable=self.threshold,
            from_=0.0, to=1.0, resolution=0.01, orient="horizontal",
            length=320, showvalue=False,
            bg=C["bg_card"], troughcolor=C["bg_dark"],
            activebackground=C["denso_red"],
...
class ResultsScreen(tk.Frame):
    ...
    def _build_left(self, parent):
        ...
        self.thr_display = tk.Label(thr_card,
            text=f"{self.threshold.get():.2f}",
            font=("Arial", 20, "bold"), fg=C["denso_red"], bg=C["bg_card"])
        self.thr_display.pack()
        tk.Scale(thr_card, variable=self.threshold,
            from_=0.0, to=1.0, resolution=0.01, orient="horizontal",
    ...
    def _refresh_stats(self):
        ...
        self.thr_display.config(text=f"{thr:.2f}")
